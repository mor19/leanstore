...
auto main(int argc, char **argv) -> int {
  gflags::SetUsageMessage("Leanstore TPC-H");
  ...
  // TODO tmp
  auto tpch = std::make_unique<tpch::TPCHWorkload<LeanStoreAdapter>>(*db);
  tpch->part.ToggleAppendBiasMode(true);
  tpch->supplier.ToggleAppendBiasMode(true);
  tpch->partsupp.ToggleAppendBiasMode(true);
  tpch->customer.ToggleAppendBiasMode(true);
  tpch->orders.ToggleAppendBiasMode(true);
  tpch->lineitem.ToggleAppendBiasMode(true);
  tpch->nation.ToggleAppendBiasMode(true); // TODO ?
  tpch->region.ToggleAppendBiasMode(true); // TODO ?
