...
struct TPCCWorkload {
  ...
  TPCCWorkload(Integer warehouse_count, bool enable_order_wdc_index, bool enable_cross_warehouses,
      ...
      : warehouse(AdapterType<WarehouseType>(std::forward<Params>(params)..., WarehouseType::ColumnSizes())),
        district(AdapterType<DistrictType>(std::forward<Params>(params)..., DistrictType::ColumnSizes())),
        customer(AdapterType<CustomerType>(std::forward<Params>(params)..., CustomerType::ColumnSizes())),
        customer_wdc(AdapterType<CustomerWDCType>(std::forward<Params>(params)..., CustomerWDCType::ColumnSizes())),
        history(AdapterType<HistoryType>(std::forward<Params>(params)..., HistoryType::ColumnSizes())),
        neworder(AdapterType<NewOrderType>(std::forward<Params>(params)..., NewOrderType::ColumnSizes())),
        order(AdapterType<OrderType>(std::forward<Params>(params)..., OrderType::ColumnSizes())),
        order_wdc(AdapterType<OrderWDCType>(std::forward<Params>(params)..., OrderWDCType::ColumnSizes())),
        orderline(AdapterType<OrderLineType>(std::forward<Params>(params)..., OrderLineType::ColumnSizes())),
        item(AdapterType<ItemType>(std::forward<Params>(params)..., ItemType::ColumnSizes())),
        stock(AdapterType<StockType>(std::forward<Params>(params)..., StockType::ColumnSizes())),
